"""run_adaptive.py — run Falcon's adaptive controller in the P1-A harness.

Usage:  python -m sumo_demo.run_adaptive [--scenario medium] [--steps 900]
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Falcon adaptive controller in the P1-A harness")
...
def main() -> int:
    ...
    report = result.report(scenario.name, "ADAPTIVE", sink, args.steps)
    print(
        f"[ADAPTIVE] {scenario.name}: "
